...
**Requirements owned**: FR-PUB-029 – FR-PUB-040, FR-PUB-029a, FR-PUB-029b
...
*`T391` implemented `FR-PUB-034` against a unit test that asserted the failure taxonomy instead of the
