...
**Four remain open and none blocks**: `C3`, `A1`, `I2` and `N1` at MEDIUM, `C4` and `D1` at LOW.
`N1` was found **while remediating** `C1` and is the one worth settling before `T436g` writes the
registry.
