...
> Specification, APPROVED; scope ruling T-106). This Epic implements **BR-0020, BR-0021**. The prior
...
- [x] `specs/007-requirement-intelligence/defects/` contains no open defect records
