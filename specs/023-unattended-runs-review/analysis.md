...
**Resolution markers applied 2026-08-21** (session: EPIC-029 readiness pass). The findings the 2026-08-19 remediation pass closed — B1–B6, B8 — now carry the `✅` resolved marker the gate reads (declared in `tests/governance/epic-stage/analysis-record.ts`, DEF-026-008), applied only after implementation verified every closure: T823–T825, T822, T800–T810 and the spec/plan edits all landed and pass (see `closure.md`, suites green 2026-08-21). Severities are as found. B7, B9, B10 and B11 remain open and unmarked — documentation wording, none blocking.
