...
**Epic**: `EPIC-001` · **Session**: 2026-08-19
...
|---|---|---|---|---|
| F1 | Inconsistency | MEDIUM | `tasks.md` states **35** tasks and lists **47** | Correct the stated count, or state how it decomposes. Same class as EPIC-018, whose 31/32/34 became 31/37/38 before `T529` reconciled it |
| F2 | Inconsistency | MEDIUM | `plan.md` states **35** tasks; `tasks.md` lists **47** | Correct `plan.md`, or link the task list instead of restating a number that drifts |
...
| Measure | Value |
|---|---|
| Requirements owned | 5 — `FR-024`, `FR-025`, `FR-026`, `FR-027`, `FR-028` |
| Owned requirements cited by a task or feature note | 5 of 5 |
| Tasks listed | 47 |
| Feature sections | 5 |
