# Epic Specification: Metrics \& Reporting

**Epic**: `EPIC-040` | **Module**: PMI-DOC-004 v2.0 §6.19
**Feature Branch**: `epic/040-metrics-reporting`
**Created**: 2026-08-25
...
The **Reports** area of PMI-DOC-006 §4.1 had **no owning Epic**. Its requirements were not missing —
PMI-DOC-004 v2.0 §6.19 carries them — but nothing in `specs/` claimed them, so the shell registry
...
Metrics, reporting and cost. Deferred furthest because reporting specified over an execution registry that does not yet exist would be written against a moving target.
...
against §6.19 properly.

## Scope claimed

| | |
|---|---|
| **Application area** | Reports (PMI-DOC-006 §4.1) |
| **Requirements** | PMI-DOC-004 v2.0 §6.19 — BR-0180 · BR-0181 · BR-0182 · BR-0183 · BR-0184 |
| **Lifecycle state** | **Ownership declared** — awaiting `/speckit-specify` |
| **Priority** | **P3** |
| **Scheduling disposition** | Deferred — lowest priority |
...
`/speckit-specify` against PMI-DOC-004 v2.0 §6.19, producing a real `spec.md` that supersedes
