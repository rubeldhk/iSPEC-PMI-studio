# Analysis: Specification Authoring & Generation

**Epic**: `EPIC-008` · **Session**: 2026-08-19
...
| Measure | Value |
|---|---|
| Requirements owned | 4 — `FR-010`, `FR-012`, `FR-029`, `FR-032` |
| Owned requirements cited by a task or feature note | 2 of 4 |
| Tasks listed | 23 |
| Feature sections | 7 |
