# Analysis: Specification Interface

**Epic**: `EPIC-010` · **Session**: 2026-08-19
...
| Measure | Value |
|---|---|
| Requirements owned | 2 — `FR-012`, `FR-028` |
| Owned requirements cited by a task or feature note | 1 of 2 |
| Tasks listed | 19 |
| Feature sections | 2 |
