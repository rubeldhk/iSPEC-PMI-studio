# Analysis: Steering Engine

**Epic**: `EPIC-019` · **Session**: 2026-08-19
...
|---|---|---|---|---|
| F1 | Coverage Gap | MEDIUM | 4 of 5 owned requirements are cited by no task or feature note: `FR-ENH-001`, `FR-ENH-003`, `FR-ENH-004`, `FR-ENH-005` | `traceability-convention.md` makes **Feature → requirements it satisfies** mandatory, carried in the `F-<epic>.<n>` framing note. The work is described; the link is not. MEDIUM rather than HIGH because this is a missing trace, not missing coverage |
| F2 | Coverage Gap | MEDIUM | 3 feature sections and none names the requirements it satisfies | Add the requirement reference to each `F-<epic>.<n>` framing note (`traceability-convention.md`, mandatory link) |
...
| Measure | Value |
|---|---|
| Requirements owned | 5 — `FR-ENH-001`, `FR-ENH-002`, `FR-ENH-003`, `FR-ENH-004`, `FR-ENH-005` |
| Owned requirements cited by a task or feature note | 1 of 5 |
| Tasks listed | 27 |
| Feature sections | 3 |
