...
- [ ] T1407 Add `CONTRACT_VERSION`, the codes, headers and types to `packages/execution-registry-contract/src/contract.ts` and export them from `packages/execution-registry-contract/src/index.ts` (unit test: T1406) — `R-043-5`, `R-043-6`
