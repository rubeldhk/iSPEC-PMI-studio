...
- [ ] T1541 **ADRs and records** — confirm `adr/ADR-0030-local-first-execution-and-integration-contract.md` carries its 2026-09-04 `EPIC-042` amendment (`FR-EXT-070`) and `.specify/memory/constitution.md` reads version `1.6.1` with the Directory-contract sentence on generated constitutions (`FR-EXT-071`), and record both in `specs/042-pmi-spec-kit-extension/closure.md` (analysis `C2`)
