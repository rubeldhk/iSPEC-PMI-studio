...
> Specification, APPROVED; scope ruling T-106). This Epic implements **BR-0100**. The prior
...
- [x] `specs/016-architecture-decision-records/defects/` contains no open defect records
