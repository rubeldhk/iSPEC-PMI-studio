...
- [ ] T1208 [US1] Confirm the approval on screen — after a successful baseline the region still reads "Nothing is outstanding" and still offers **Approve baseline**, so a person cannot tell it worked. Found by the `T1174` walk; invisible to 4890 tests
